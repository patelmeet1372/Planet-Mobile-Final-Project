<?php
  ...
  WHERE p.Model='iPhone 13' AND p.ProductID=ps.ProductID";
...
<body>
    <section>
    <h1 style="font-family: 'montserrat'; color: white; position: relative; top: 40px;">iPhone 13</h1>       
     <!-- TABLE CONSTRUCTION -->
    ...
    style="font-family: 'montserrat'; font-size:23px; color: white; position: relative; top: 200px; padding-left: 650px">
    <b><u>Back to iPhones</u></b> </a>
</body>
<div class = "navbar navbar-dark bg-dark" style="background: linear-gradient(to right, white, rgb(249, 251, 252)); position: relative; top: 223px; height: 67px;">
