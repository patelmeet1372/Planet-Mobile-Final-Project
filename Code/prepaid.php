...
$sql = "SELECT Model, Brand, Price FROM products
WHERE ProductID IN
(select ProductID FROM products WHERE Price<100
UNION
SELECT ProductID FROM phone_specs WHERE RAM < '1GB'
);";
...
<h1 style="font-family: 'montserrat'; color:white; position: relative; top: 100px; padding-left: 450px">
<?php
            ...
            style="color: rgb(255, 255, 255); font-family: 'montserrat'; font-size: 30px; position: relative; top: 323px; padding-left:580px">
            <b><u>Back to HomePage</u></b> </a>
</body>
<div class = "navbar navbar-dark bg-dark" style="background: linear-gradient(to right, white, rgb(249, 251, 252)); position: relative; top: 340px; height: 67px;">
