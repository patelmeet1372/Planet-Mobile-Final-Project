...
$sql = "SELECT City FROM customer AS A
LEFT JOIN cart_contents AS B ON A.CustomerID = B.CustomerID
UNION
SELECT City FROM customer AS A
RIGHT JOIN cart_contents AS B ON A.CustomerID = B.CustomerID";
...
<nav class="navbar-expand-lg navbar-light">
    ...
    <h1 style="font-family: 'montserrat'; color: white; position: relative; top: 40px;">
        Our Most 👀 Recent <span style="color: rgb(226, 53, 53); font-family: 'montserrat'; font-size: 40px;" >
          PURCHASES !!!</span>
    </h1>
</div>
<body>
<h1 style="font-family: 'montserrat'; color:white; position: relative; top: 100px; padding-left:670px">
...
<?php
            ...
            style="color: rgb(255, 255, 255); font-family: 'montserrat'; font-size: 30px; position: relative; top: 85px; padding-left:590px">
            <b><u>Back to HomePage</u></b> </a>
</body>
<div class = "navbar navbar-dark bg-dark" style="background: linear-gradient(to right, white, rgb(249, 251, 252)); position: relative; top: 100px; height: 67px;">
