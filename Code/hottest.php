...
$sql = "SELECT Model, Brand, ProductID
FROM products
WHERE ProductID = ANY
  (SELECT ProductID
  FROM cart_contents
  WHERE cart_contents.Quantity >1 AND products.ProductID=cart_contents.ProductID)
  Group By Brand;";
...
<nav class="navbar-expand-lg navbar-light">
    ...
    <h1 style="font-family: 'montserrat'; color: white; position: relative; top: 40px;">
        Our Hottest&#128293; Picks for the <span style="color: rgb(226, 53, 53); font-family: 'montserrat'; font-size: 40px;" >
          SALE !!!</span>
    </h1>
</div>
<h1 style="font-family: 'montserrat'; color:white; position: relative; top: 100px; padding-left:530px">
<?php
            ...
            style="color: rgb(255, 255, 255); font-family: 'montserrat'; font-size: 30px; position: relative; top: 275px; padding-left:630px">
            <b><u>Back to HomePage</u></b> </a>
</body>
<div class = "navbar navbar-dark bg-dark" style="background: linear-gradient(to right, white, rgb(249, 251, 252)); position: relative; top: 295px; height: 67px;">
